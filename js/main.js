...
(function () {
  ...
  function initConsultationModal() {
    ...
    modal.innerHTML = [
      ...
      '      </div>',
      '    </aside>',
      '    <form class="form-card js-contact-form" novalidate data-form-endpoint="https://formsubmit.co/ajax/billydevona@gmail.com">',
      ...
      '      <input type="hidden" name="_cc" value="admin@devonaaccounting.com" />',
